...
function downloadKubeScore(version = undefined) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield io.mv(downloadPath, path.join(downloadPath, 'kube-score'));
        core.info('Adding kube-score to the cache ...');
        const toolPath = yield tc.cacheDir(downloadPath, 'node', version || getLatestVersionTag());
        core.info('Done');
...
function runKubeScore() {
    return __awaiter(this, void 0, void 0, function* () {
        yield exec.exec('kube-score', ['version']);
    });
}
...
function getLatestVersionTag() {
    return __awaiter(this, void 0, void 0, function* () {
        return yield request('https://api.github.com/repos/zegl/kube-score/releases/latest', { json: true }, (err, res, body) => {
            if (err) {
