...
function runKubeScore(dirs) {
    return __awaiter(this, void 0, void 0, function* () {
        for (const dir of dirs) {
            ...
            const files = yield getFilesInActualDir(actualDir);
            core.info(files);
...
function getFilesInActualDir(actualDir) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield glob(actualDir, (err, files) => __awaiter(this, void 0, void 0, function* () {
            if (err) {
                core.setFailed(err);
                return [];
            }
